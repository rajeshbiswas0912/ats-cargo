            ...
            <div class="card border">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
                      <input type="text" class="form-control" id="p_pincode" name="p_pincode" placeholder="Pincode">
                    </div>
                  </div>
                  <div class="col-lg-3">
                    <div class="form-group">
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      <input type="text" class="form-control" id="p_address" name="p_address" placeholder="Address">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card border">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
                      <input type="text" class="form-control" id="d_pincode" name="d_pincode" placeholder="Pincode">
                    </div>
                  </div>
                  <div class="col-lg-3">
                    <div class="form-group">
